...
for i=1:numImagenes(2)
  ...
  Green=uint16(imagenActual(:,:,2));
   ...
   clear imagenActual Green Blue;
    ...
    tiffBM= Tiff(strcat('Tiffs 16 bits/Per bandes/',name_im,'_0.tif'),'w');
        ...
        tiffB1= Tiff(strcat('Tiffs 16 bits/Per bandes/',name_im,'_1.tif'),'w');
        ...
        tiffB2= Tiff(strcat('Tiffs 16 bits/Per bandes/',name_im,'_2.tif'),'w');
            ...
            tiffB3= Tiff(strcat('Tiffs 16 bits/Per bandes/',name_im,'_3.tif'),'w');
            ...
            tiffB4= Tiff(strcat('Tiffs 16 bits/Per bandes/',name_im,'_4.tif'),'w');
            ...
            tiffB5= Tiff(strcat('Tiffs 16 bits/Per bandes/',name_im,'_5.tif'),'w');
...
for i=1:numImagenes(2)
  ...
  Green=uint16(imagenActual(:,:,2));
   ...
   clear imagenActual Green Blue;
    ...
    tiffFinal= Tiff(strcat('Tiffs 16 bits/6 bandes/',name_im,'.tif'),'w');
