function [varargout] =NDVI_Multibanda(R670,R780,iteracion,chkImagenes,chkProceso,tipoCmap,boolHist,status_cuad,cuad_div,rgb_g_limits,auxiliar_limits,status_suelo,check_aux) % Primero NIR luego RED
%---------------------------------------------------------------%
