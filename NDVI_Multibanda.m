function [varargout] =NDVI_Multibanda(R670,R780,iteracion,chkImagenes,chkProceso,tipoCmap,boolHist,status_cuad,cuad_div,rgb_g_limits,auxiliar_limits,status_suelo,check_aux,varargin) % Primero NIR luego RED
%---------------------------------------------------------------%
...
ND_IR= ND_Banda_LK (chkImagenes,chkProceso,R780,iteracion,varargin{1});  
ND_RED= ND_Banda_LK (chkImagenes,chkProceso,R670,iteracion,varargin{2});
     
elseif nargin ==13
    ND_RED= ND_Banda_LK (chkImagenes,chkProceso,R670,iteracion);
ND_IR= ND_Banda_LK (chkImagenes,chkProceso,R780,iteracion);
...
% current_process=waitbar(1,'Calculando Índice de Vegetación');
