function [varargout]= MCARI_Multibanda (R550,R670,R700,iteracion,chkImagenes,chkProceso,tipoCmap,boolHist,status_cuad,cuad_div,rgb_g_limits,auxiliar_limits,status_suelo,check_aux,varargin)
...
if nargin==17% En este caso entra una imagen multibanda, de modo que en lugar de los paths se pasan las matrices
%msgbox(num2str(nargin));
LK_R550= ND_Banda_LK (chkImagenes,chkProceso,R550,iteracion,varargin{1}); 
LK_R670= ND_Banda_LK (chkImagenes,chkProceso,R670,iteracion,varargin{2}); 
LK_R700= ND_Banda_LK (chkImagenes,chkProceso,R700,iteracion,varargin{3}); 

     
elseif nargin ==13
LK_R550= ND_Banda_LK (chkImagenes,chkProceso,R550,iteracion); 
LK_R670= ND_Banda_LK (chkImagenes,chkProceso,R670,iteracion); 
LK_R700= ND_Banda_LK (chkImagenes,chkProceso,R700,iteracion); 
