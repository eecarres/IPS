...
listaOpcionesTetraCam=get(handles.popConfigTetra,'String');

configTetracam=listaOpcionesTetraCam{get(handles.popConfigTetra,'Value')};
...
function popConfigTetra_Callback(hObject, eventdata, handles)
% hObject    handle to popConfigTetra (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popConfigTetra contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popConfigTetra
guidata(hObject, handles);

% --- Executes during object creation, after setting all properties.
function popConfigTetra_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popConfigTetra (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
