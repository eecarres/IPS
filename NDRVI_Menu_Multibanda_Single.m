    ...
    for i=1:numImagenes(2) 
      ...
      identificadorIndices=['Indices calculados y banda correspondiente'];
         ...
         % Calculamos NDVI si se ha seleccionado la opción
          ...
          NDVI_Actual=NDVI_Multibanda(R670,R800,i,chkImagenes,chkProceso,opcion_cmap,status_hist,status_cuad,handles.cuad_div,handles.rgb_g_limits,handles.auxiliar_limits,handles.status_suelo,handles.check_aux,dataIm(:,:,R800.id),dataIm(:,:,R670.id));                 
            ...
            DCNI_Actual=DCNI_Multibanda(R720,R710,R670,i,chkImagenes,chkProceso,opcion_cmap,status_hist,status_cuad,handles.cuad_div,handles.rgb_g_limits,handles.auxiliar_limits,handles.status_suelo,handles.check_aux,dataIm(:,:,R720.id),dataIm(:,:,R710.id),dataIm(:,:,R670.id));                 
            numBandas=numBandas+1;
           ...
           TCARI_Actual=TCARI_OSAVI_Multibanda(R710,R670,R550,R800,i,chkImagenes,chkProceso,opcion_cmap,status_hist,status_cuad,handles.cuad_div,handles.rgb_g_limits,handles.auxiliar_limits,handles.status_suelo,handles.check_aux,dataIm(:,:,R710.id),dataIm(:,:,R670.id),dataIm(:,:,R550.id),dataIm(:,:,R800.id));                 
            numBandas=numBandas+1;
