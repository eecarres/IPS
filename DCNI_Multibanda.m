...
if nargin==17% En este caso entra una imagen multibanda
    LK_R730= ND_Banda_LK (chkImagenes,chkProceso,R730,iteracion,varargin{1});   
LK_R710= ND_Banda_LK (chkImagenes,chkProceso,R710,iteracion,varargin{2});
LK_R670= ND_Banda_LK (chkImagenes,chkProceso,R670,iteracion,varargin{3});
    
elseif nargin==14 % Entran las imágenes en los objetos banda
    
LK_R730= ND_Banda_LK (chkImagenes,chkProceso,R730,iteracion);   
LK_R710= ND_Banda_LK (chkImagenes,chkProceso,R710,iteracion);
LK_R670= ND_Banda_LK (chkImagenes,chkProceso,R670,iteracion);

else % Caso no identificado, error de lectura de bandas
    
    msgbox('Error, caso no identificado','Error');
    return;
