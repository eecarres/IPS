...
%bandasProyecto está ordenada de menos a mas LDO (LDO menor primero)
...
disp('Datos de calibración de cada banda [reflectancia / valor digital]');
...
%% Análisis de las imágenes de Entrada
...
%% Análisis de las reflectancias de las imágenes
...
%% Comparación entre imágenes calibradas y sin calibrar
...
im16BitsCIR=im16BitsCIR/1024; %Se pasa a imagen de 0 a 1 para que estén en condiciones iguales para compararse
...
figure('Name','Comparación Imágenes en CIR','Position',[0 0 1920 700]);
