...
colormapSeleccionado=get(get(handles.pnlColormap,'SelectedObject'),'String');% Obtenemos primero el handles del radiobutton seleccionado y luego el string de éste.
